...
public class PronotypeResource {
    ...
    public ResponseEntity<Pronotype> createPronotype(@RequestBody Pronotype pronotype) throws URISyntaxException {
        ...
        if (pronotype.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new pronotype cannot already have an ID")).body(null);
        }
    ...
    @Timed
    public ResponseEntity<List<Pronotype>> getAllPronotypes(@ApiParam Pageable pageable) {
