...
import com.betcoin.repository.CompetitionRepository;
import com.betcoin.service.CompetitionService;
...
public class CompetitionResourceIntTest {
    ...
    public void setup() {
        ...
        CompetitionResource competitionResource = new CompetitionResource(competitionService);
